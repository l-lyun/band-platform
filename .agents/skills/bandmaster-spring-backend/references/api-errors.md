...
| `A09` | 400 | 지원하지 않는 소셜 로그인 제공자입니다. |
| `A10` | 400 | 소셜 로그인 상태 값이 올바르지 않습니다. |
| `A11` | 400 | 소셜 로그인 리다이렉트 URI가 올바르지 않습니다. |
| `A12` | 400 | 소셜 로그인 사용자 정보가 올바르지 않습니다. |
| `A13` | 500 | 소셜 로그인 설정이 올바르지 않습니다. |
